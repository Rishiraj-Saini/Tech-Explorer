    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/api/skills", exchange -> {
            ...
            String response =
                    ...
                    + "{"
                    + "\"name\":\"Machine Learning&Genrative AI\","
                    + "\"demand\":\"High\","
                    + "\"level\":\"Advanced\""
                    + "}"
        ...
        server.createContext("/api/jobs", exchange -> {
            ...
            String response =
                    ...
                    + "\"skills\":\"Python, SQL, Prompt Engineering, API\""
                    + "},"
        ...
        server.createContext("/api/programs", exchange -> {
            ...
            String response =
                    ...
                    + "\"skill\":\"Java,Java Spring Boot,Programing Languages\","
                    + "\"duration\":\"6 Months\""
                    + "},"

                    + "{"
                    + "\"name\":\"Python Programming & Data Base Management\","
                    + "\"skill\":\"Python,SQL\","
                    + "\"duration\":\"4 Months\""
                    + "},"
                    ...
                    + "{"
                    + "\"name\":\"AI & ML Engineer\","
                    + "\"skill\":\"Machine Learning,LLMs,Genrative AI\","
                    + "\"duration\":\"5 Months\""
                    + "},"

                    + "{"
                    + "\"name\":\"Cyber Scurity\","
                    + "\"skill\":\"Networking,Oparting Systems,Web & Application Security,Network Security\","
                    + "\"duration\":\"10 Months\""
                    + "}"
